    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Add New House</h2>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">House ID</label>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $q = "insert into ressidential values ($buildingno,'$type','houses',$buildingid)  ";
  $query_id2 = oci_parse($con, $q);
  $r = oci_execute($query_id2);

  $q = "insert into houses values($houseid,$no_of_rooms,$buildingno,$object) ";
  $query_id2 = oci_parse($con, $q);
  $r = oci_execute($query_id2);
